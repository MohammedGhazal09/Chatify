  ...
  return (
    <div className="composer-dock w-full max-w-full overflow-hidden border-t border-[var(--chat-border)] bg-[var(--chat-panel)] px-5 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-3 md:px-8">
      ...
      <div className="mx-auto flex max-w-[880px] items-center gap-3">
        <button
          type="button"
          className="grid h-12 w-12 shrink-0 place-items-center rounded-[var(--chat-radius-md)] border border-[var(--chat-border)] bg-[var(--chat-panel-elevated)] text-[var(--chat-text-muted)] hover:bg-[var(--chat-panel-subtle)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--chat-focus)] md:h-10 md:w-10"
        ...
        <button
          type="button"
          className="hidden h-10 w-10 shrink-0 place-items-center rounded-[var(--chat-radius-md)] border border-[var(--chat-border)] bg-[var(--chat-panel-elevated)] text-[var(--chat-text-muted)] hover:bg-[var(--chat-panel-subtle)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--chat-focus)] md:grid"
      ...
      {sendDisabledReason && (
        <p id="composer-disabled-reason" className="mx-auto mt-2 max-w-[880px] text-sm text-[var(--chat-warning)]" aria-live="polite">
          {sendDisabledReason}
        </p>
      )}
      {isSendError && (
