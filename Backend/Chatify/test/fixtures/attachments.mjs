...
const WEBM_EBML_HEADER = Buffer.from([
...
export const tinyDetectedWebmVoiceBuffer = (suffix = '') => Buffer.concat([
  WEBM_EBML_HEADER,
  Buffer.from(String(suffix), 'utf8'),
]);

export const tinyVoiceBuffer = (text = 'voice fixture') => tinyDetectedWebmVoiceBuffer(text);
