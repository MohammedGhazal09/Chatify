...
const Signup = () => {
  ...
  const socialButtons = [
    { icon: FaGoogle, label: 'Google', color: 'hover:bg-red-600' },
    { icon: FaGithub, label: 'GitHub', color: 'hover:bg-red-600' },
    { icon: FaLinkedin, label: 'LinkedIn', color: 'hover:bg-red-600' }
  ];
