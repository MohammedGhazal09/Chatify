...
const AttachmentPreview = ({ attachment, compact = false, onOpenPreview }: AttachmentPreviewProps) => {
  ...
  return (
    <div className="mt-2 flex min-w-0 flex-wrap items-center gap-3 rounded-[var(--chat-radius-md)] border border-[var(--chat-border)] bg-[var(--chat-panel-elevated)] px-3 py-2 text-[var(--chat-text)]">
      ...
      {isUnavailable ? (
        <span className="ml-auto shrink-0 text-xs text-[var(--chat-text-muted)]">Unavailable</span>
      ) : (
